...
if __name__ == '__main__':
    ...
    while(1):
        try:
            ...
            H1, H2, rect_pts1, rect_pts2, gray1_rect, gray2_rect =\
                utils.rectification(gray1, gray2, list_kp1, list_kp2, F)
            break
        except Exception:
            continue
    ...
    left_lines, _ = utils.drawlines(gray1_rect, gray2_rect,
    ...
    right_lines, _ = utils.drawlines(
        gray2_rect, gray2_rect, lines2, rect_pts2, rect_pts1)

    disparity_map_unscaled, disparity_map_scaled = utils.ssdCorrespondence(
        gray1_rect, gray2_rect)
